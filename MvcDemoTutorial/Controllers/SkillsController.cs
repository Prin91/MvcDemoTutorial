...
namespace MvcDemoTutorial.Controllers
{
    public class SkillsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Skill_Id,Student_Id,SkillName,Skill_Level")] Skills skills)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Skill_Id,Student_Id,SkillName,Skill_Level")] Skills skills)
        {
            if (ModelState.IsValid)
            {
